...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  final screenSize = MediaQuery.of(context).size; // Define screenSize here
  Color buttonColor = getBtnColor(value);
  Icon? buttonIcon;
  ...
  if (value == Btn.add) {
    ...
    buttonIcon = Icon(Icons.clear);
  } else if (value == Btn.divide) {
  buttonIcon = Icon(CupertinoIcons.divide);
}
